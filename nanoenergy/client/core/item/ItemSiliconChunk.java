...
public class ItemSiliconChunk extends Item {
public ItemSiliconChunk(int id, int texture) {
super(id); //Returns super constructor: par1 is ID
this.setTextureFile("/nanoenergy/items.png"); //Sets the item texture file
this.setItemName("siliconchunk"); //Sets the incode name of the item, make sure it doesn't clash with other items, weird stuff happens
