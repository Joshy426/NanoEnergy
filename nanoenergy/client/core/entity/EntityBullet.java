...
public class EntityBullet extends Entity implements IProjectile
{
	 private int xTile = -1;
	    ...
	    public static DamageSource causeArrowDamage(EntityBullet par0EntityArrow, Entity par1Entity) {        
	        ...
	        else
	        {
	            ...
	            if (var4 != null)
	            {
	                if (var4.entityHit != null)
	                {
	                    ...
	                    {
	                        var21 = this.causeArrowDamage(this, this);
	                    }
	                    else
	                    {
	                        var21 = this.causeArrowDamage(this, this.shootingEntity);
	                    }
