...
public abstract class EntityBulletMain extends Entity
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityBulletMain(World par1World)
    {
        super(par1World);
    ...
    public EntityBulletMain(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
    {
        super(par1World);
        this.setSize(1.0F, 1.0F);
    ...
    public EntityBulletMain(World par1World, EntityLiving par2EntityLiving, double par3, double par5, double par7)
    {
        super(par1World);
