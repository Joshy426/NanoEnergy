package nanoenergy.common.core.network;
...
public abstract class Packet {
	...
	protected Packet(Player player) {
		this.player = player;
	...
	protected Packet(DataInputStream data, Player player) {
		this.player = player;
		this.datain = data;
	}
	...
	public Packet250CustomPayload getPacket250() {
		...
		return new Packet250CustomPayload("NanoEnergy Channel",
				bytes.toByteArray());
	}
