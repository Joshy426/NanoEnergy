...
private static final CraftTable instance = new CraftTable();
/** A list of all the recipes added */
private List recipes = new ArrayList();
/**
         * Returns the static instance of this class
         */
public static final CraftTable getInstance()
{
         return instance;
}
private CraftTable()
{
         ...
         System.out.println(this.recipes.size() + " Nano Table Recipes");
}
/**
...
void addShapelessRecipe(ItemStack itemstack, Object ... inputArray)
{
 ...
 //This also adds a recipe, but in this case the ordinace of the inputs is not significant.
